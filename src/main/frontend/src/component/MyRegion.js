...
export default function MyRegion(props) {
    ...
    const hospList = (cd) => {
        ...
        let url;
        if(props.mode===0){
            url = `https://apis.data.go.kr/B551182/hospInfoServicev2/getHospBasisList?serviceKey=G3OZp5dYqrTm0I9gNRRu%2BXouEslD9Gs7F%2BYz9LUKT8%2F%2BJjRHdzSmmSwbLnJ7vR6znJD4hftgOK5ZZ%2FCE9iG3XA%3D%3D&pageNo=1&numOfRows=1000&emdongNm=${selectedRegion} ${cd}`;
        }else if(props.mode===1){
            url = `https://apis.data.go.kr/B551182/hospInfoServicev2/getHospBasisList?serviceKey=G3OZp5dYqrTm0I9gNRRu%2BXouEslD9Gs7F%2BYz9LUKT8%2F%2BJjRHdzSmmSwbLnJ7vR6znJD4hftgOK5ZZ%2FCE9iG3XA%3D%3D&pageNo=1&numOfRows=1000&emdongNm=${selectedRegion} ${cd}&dgsbjtCd=${props.code}`;
        }
        axios.get(url)
            .then(response => {
